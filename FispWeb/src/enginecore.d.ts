declare module EngineCore {
    ...
    class Engine {
         ...
         * @param {EngineCore.Viewport} viewport - the viewport element to be used.
...
declare module EngineCore {
    ...
    class Node {
         ...
         * @param {EngineCore.Scene} the scene this node will be added to
         */
         ...
         * @param {EngineCore.Node} ancestor - The parent node to inspect
         * @see parent
         */
         ...
         * @param {EngineCore.Node[]} results the result array containing the nodes matching the given criterias
         ...
         * @param {boolean} directDescendantsOnly if true only direct descendants of 'this' will be considered, if false direct and also indirect (children of children, an so on in a recursive manner) descendants of 'this' will be considered.
         * @param predicate: an optional predicate that will be called on every evaluated children, the predicate must return true for a given child to be part of the result, otherwise it will be ignored.
         * @return {EngineCore.Node[]} all children nodes of all types.
         */
...
declare module EngineCore {
    ...
    class Scene implements IAnimatable {
        ...
        * @see EngineCore.Light
        * @type {EngineCore.Light[]}
        */
        lights: Light[];
        /**
        * All of the cameras added to this scene.
        * @see EngineCore.Camera
        * @type {EngineCore.Camera[]}
        */
        cameras: Camera[];
        ...
        * @see EngineCore.AbstractMesh
        * @type {EngineCore.AbstractMesh[]}
        */
        meshes: AbstractMesh[];
        private _geometries;
        materials: Material[];
        ...
        */
        ...
        /**
         * @constructor
         * @param {EngineCore.Engine} engine - the engine to be used to render this scene.
         */
         ...
         * @return {EngineCore.AbstractMesh} mesh under the pointer/mouse cursor or null if none.
         */
        ...
        */
         ...
         * @param {EngineCore.Animatable} [animatable] an animatable object. If not provided a new one will be created from the given params.
         * @return {EngineCore.Animatable} the animatable object created for this animation
         * @see EngineCore.Animatable
         ...
         * @return {EngineCore.Camera|null} the new active camera or null if none found.
         * @see activeCamera
         */
         ...
         * @return {EngineCore.Material|null} the material or null if none found.
         */
         ...
         * @return {EngineCore.Camera|null} the camera or null if none found.
         */
        getCameraByName(name: string): Camera;
        /**
         * get a bone using its id
         * @param {string} the bone's id
         * @return {EngineCore.Bone|null} the bone or null if not found
         */
        ...
        */
         ...
         * @return {EngineCore.Light|null} the light or null if none found.
         */
         ...
         * @return {EngineCore.ParticleSystem|null} the corresponding system or null if none found.
         */
        getParticleSystemByID(id: string): ParticleSystem;
        /**
         * get a geometry using its ID
         * @param {string} the geometry's id
         * @return {EngineCore.Geometry|null} the geometry or null if none found.
         */
        getGeometryByID(id: string): Geometry;
        /**
         * add a new geometry to this scene.
         * @param {EngineCore.Geometry} geometry - the geometry to be added to the scene.
         ...
         * @param {EngineCore.Geometry} geometry - the geometry to be removed from the scene.
         ...
         * @return {EngineCore.AbstractMesh|null} the mesh found or null if not found at all.
         */
         ...
         * @param {string} id - the id to search for
         * @return {EngineCore.Node|null} the node found or null if not found at all.
         */
         ...
         * @param {EngineCore.Vector3} [gravity] - the scene's gravity for the physics engine
         * @param {EngineCore.IPhysicsEnginePlugin} [plugin] - The physics engine to be used. defaults to OimoJS.
         ...
         * @param {EngineCore.Vector3} [gravity] - the new gravity to be used
         */
...
declare module EngineCore {
    ...
    class ActionManager {
         ...
         * @param {EngineCore.Action} action - the action to be registered
         * @return {EngineCore.Action} the action amended (prepared) after registration
         */
        registerAction(action: Action): Action;
        /**
         * Process a specific trigger
         * @param {number} trigger - the trigger to process
         * @param evt {EngineCore.ActionEvent} the event details to be processed
         */
...
declare module EngineCore {
    ...
    interface ICameraInput<TCamera extends EngineCore.Camera> {
        camera: TCamera;
        getTypeName(): string;
    ...
    interface CameraInputsMap<TCamera extends EngineCore.Camera> {
        [name: string]: ICameraInput<TCamera>;
        [idx: number]: ICameraInput<TCamera>;
    }
    class CameraInputsManager<TCamera extends EngineCore.Camera> {
...
declare module EngineCore.Debug {
    /**
...
declare module EngineCore {
    ...
    class ScreenSpaceCanvas2D extends Canvas2D {
         ...
         *  - isVisible: true if the canvas must be visible, false for hidden. Default is true.
         * - backgroundRoundRadius: the round radius of the background, either backgroundFill or backgroundBorder must be specified.
         * - backgroundFill: the brush to use to create a background fill for the canvas. can be a string value (see EngineCore.Canvas2D.GetBrushFromString) or a IBrush2D instance.
         * - backgroundBorder: the brush to use to create a background border for the canvas. can be a string value (see EngineCore.Canvas2D.GetBrushFromString) or a IBrush2D instance.
         * - backgroundBorderThickness: if a backgroundBorder is specified, its thickness can be set using this property
         * - customWorldSpaceNode: if specified the Canvas will be rendered in this given Node. But it's the responsibility of the caller to set the "worldSpaceToNodeLocal" property to compute the hit of the mouse ray into the node (in world coordinate system) as well as rendering the cached bitmap in the node itself. The properties cachedRect and cachedTexture of Group2D will give you what you need to do that.
         * - paddingTop: top padding, can be a number (will be pixels) or a string (see EngineCore.PrimitiveThickness.fromString)
         * - paddingLeft: left padding, can be a number (will be pixels) or a string (see EngineCore.PrimitiveThickness.fromString)
         * - paddingRight: right padding, can be a number (will be pixels) or a string (see EngineCore.PrimitiveThickness.fromString)
         * - paddingBottom: bottom padding, can be a number (will be pixels) or a string (see EngineCore.PrimitiveThickness.fromString)
         * - padding: top, left, right and bottom padding formatted as a single string (see EngineCore.PrimitiveThickness.fromString)
         */
        constructor(scene: Scene, settings?: {
            children?: Array<Prim2DBase>;
            id?: string;
...
declare module EngineCore {
    ...
    class SceneLoader {
        ...
        * @param engine is the instance of EngineCore.Engine to use to create the scene
        */
        ...
        * @param rootUrl a string that defines the root url for scene and resources
        * @param sceneFilename a string that defines the name of the scene file. can start with "data:" following by the stringified version of the scene
        * @param scene is the instance of EngineCore.Scene to append to
        */
...
declare module EngineCore {
    class EffectFallbacks {
        ...
        addCPUSkinningFallback(rank: number, mesh: EngineCore.AbstractMesh): void;
...
declare module EngineCore {
     ...
     */
    class PBRMaterial extends EngineCore.Material {
        /**
...
declare module EngineCore {
    class AbstractMesh extends Node implements IDisposable {
        ...
        */
        actionManager: ActionManager;
        physicsImpostor: EngineCore.PhysicsImpostor;
...
declare module EngineCore {
    ...
    class Mesh extends AbstractMesh implements IGetSetVerticesData {
        ...
        */
         ...
         * - EngineCore.VertexBuffer.PositionKind
         * - EngineCore.VertexBuffer.UVKind
         * - EngineCore.VertexBuffer.UV2Kind
         * - EngineCore.VertexBuffer.UV3Kind
         * - EngineCore.VertexBuffer.UV4Kind
         * - EngineCore.VertexBuffer.UV5Kind
         * - EngineCore.VertexBuffer.UV6Kind
         * - EngineCore.VertexBuffer.ColorKind
         * - EngineCore.VertexBuffer.MatricesIndicesKind
         * - EngineCore.VertexBuffer.MatricesIndicesExtraKind
         * - EngineCore.VertexBuffer.MatricesWeightsKind
         * - EngineCore.VertexBuffer.MatricesWeightsExtraKind
         */
        getVerticesData(kind: string, copyWhenShared?: boolean): number[] | Float32Array;
        /**
        ...
        isDisposed(): boolean;
        /**
         * Sets the mesh side orientation : EngineCore.Mesh.FRONTSIDE, EngineCore.Mesh.BACKSIDE, EngineCore.Mesh.DOUBLESIDE or EngineCore.Mesh.DEFAULTSIDE
         ...
         * You can also set the mesh side orientation with the values : EngineCore.Mesh.FRONTSIDE (default), EngineCore.Mesh.BACKSIDE or EngineCore.Mesh.DOUBLESIDE
         ...
         * The parameter `cap` sets the way the extruded shape is capped. Possible values : EngineCore.Mesh.NO_CAP (default), EngineCore.Mesh.CAP_START, EngineCore.Mesh.CAP_END, EngineCore.Mesh.CAP_ALL
...
declare module EngineCore.Internals {
    class MeshLODLevel {
        distance: number;
        mesh: Mesh;
...
declare module EngineCore {
    class HDRRenderingPipeline extends PostProcessRenderPipeline implements IDisposable {
        ...
        */
         ...
         * @param {EngineCore.Scene} scene - The scene linked to this pipeline
         * @param {any} ratio - The size of the postprocesses (0.5 means that your postprocess will have a width = canvas.width 0.5 and a height = canvas.height 0.5)
         * @param {EngineCore.PostProcess} originalPostProcess - the custom original color post-process. Must be "reusable". Can be null.
         * @param {EngineCore.Camera[]} cameras - The array of cameras that the rendering pipeline will be attached to
         */
...
declare module EngineCore {
    class LensRenderingPipeline extends PostProcessRenderPipeline {
        ...
        */
         ...
         *      grain_texture: EngineCore.Texture;     // texture to use for grain effect; if unset, use random B&W noise
...
declare module EngineCore {
    class SSAORenderingPipeline extends PostProcessRenderPipeline {
        ...
        */
         ...
         * @return {EngineCore.BlurPostProcess} The horizontal blur post-process
         */
        getBlurHPostProcess(): BlurPostProcess;
        /**
         * Returns the vertical blur PostProcess
         * @return {EngineCore.BlurPostProcess} The vertical blur post-process
         */
...
declare module EngineCore {
    class VolumetricLightScatteringPostProcess extends PostProcess {
        ...
        */
         ...
         * @param {EngineCore.Camera} camera - The camera that the post-process will be attached to
         * @param {EngineCore.Mesh} mesh - The mesh used to create the light scattering
         * @param {number} samples - The post-process quality, default 100
         * @param {number} samplingMode - The post-process filtering mode
         * @param {EngineCore.Engine} engine - The babylon engine
         * @param {boolean} reusable - If the post-process is reusable
         * @param {EngineCore.Scene} scene - The constructor needs a scene reference to initialize internal components. If "camera" is null (RenderPipelineà, "scene" must be provided
         */
         ...
         * @param {EngineCore.Vector3} The new custom light position
         */
        setCustomMeshPosition(position: Vector3): void;
        /**
         * Returns the light position for light scattering effect
         * @return {EngineCore.Vector3} The custom light position
         */
         ...
         * @return {EngineCore.RenderTargetTexture} The render target texture used by the post-process
         */
        ...
        * @param {EngineCore.Scene} The scene where to create the mesh
        * @return {EngineCore.Mesh} the default mesh
        */
...
declare module EngineCore {
    class VideoTexture extends Texture {
         ...
         * @param {EngineCore.Scene} scene is obviously the current scene.
...
declare namespace EngineCore.Internals {
    /**
